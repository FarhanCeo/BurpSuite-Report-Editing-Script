...
for span in soup.find_all("span", class_="TEXT"):
    for tag in span.find_all(["p", "li"]):  # Find <p> and <li> inside the span
        if "style" in tag.attrs:
            tag["style"] += "; text-align: justify;"  # Append justify style
        else:
            tag["style"] = "text-align: justify;"  # Add justify style
